...
pub struct DeviceResponsesInner {
    ...
    pub newest_events: Option<::std::collections::HashMap<String, crate::models::DeviceResponseNewestEventsValue>>,
    ...
    pub users: Option<Vec<crate::models::DeviceResponseUsersInner>>,
}

impl DeviceResponsesInner {
    pub fn new() -> DeviceResponsesInner {
